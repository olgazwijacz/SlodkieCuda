...
function doc_helper( $title, $url, $class = null ) {
	...
	__( 'See %s configuration tips in the impleCode documentation', 'post-type-x' ), $title ) . '.</div>
		<div class="doc-button"><a href="https://implecode.com/docs/ecommerce-product-catalog/' . $url . '/?cam=catalog-docs-box&key=' . $url . '"><input class="doc_button classic-button" type="button" value="' . __( 'See in Docs', 'post-type-x' ) . '"></a></div>
...
function did_know_helper( $name, $desc, $url, $class = null ) {
	...
	__( 'Did you know?', 'post-type-x' ) . '</div>
		...
		<div class="doc-button"><a href="' . $url . '?cam=catalog-know-box&key=' . $name . '"><input class="doc_button classic-button" type="button" value="' . __( 'See Now', 'post-type-x' ) . '"></a></div>
...
function ic_bug_report() {
	...
	__( 'Do you have a problem?', 'post-type-x' ) . '</div>
		...
		<div class="doc-button"><a href="https://wordpress.org/support/plugin/ecommerce-product-catalog"><input class="doc_button classic-button" type="button" value="' . __( 'Report a Problem', 'post-type-x' ) . '"></a></div>
		<a title="' . __( 'Click the button to visit support forum.', 'post-type-x' ) . '" href="https://wordpress.org/support/plugin/ecommerce-product-catalog" class="background-url"></a>
		</div></div>';
	echo $helper;
}
