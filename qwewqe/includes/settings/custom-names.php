...
function custom_names_content() {
	...
	<div class="names-product-settings settings-wrapper"> <?php
		...
		<div class="settings-submenu">
			<h3>
				<a id="single-names" class="element current" href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=names-settings&submenu=single-names' ) ?>"><?php _e( 'Single Item Page', 'post-type-x' ); ?></a>
				<a id="archive-names" class="element" href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=names-settings&submenu=archive-names' ) ?>"><?php _e( 'Listing Pages', 'post-type-x' ); ?></a>
				...
				<form method="post" action="options.php">
					...
					<table class="wp-list-table widefat product-settings-table" style="clear:right; text-align: left;">
						...
						<tbody>
							...
							<tr><td><?php _e( 'Description Label', 'post-type-x' ); ?></td><td><input type="text" name="single_names[product_description]" value="<?php echo esc_html( $single_names[ 'product_description' ] ); ?>" /></td></tr>
							<tr><td><?php _e( 'Features Label', 'post-type-x' ); ?></td><td><input type="text" name="single_names[product_features]" value="<?php echo esc_html( $single_names[ 'product_features' ] ); ?>" /></td></tr>
							<tr><td><?php _e( 'Another Categories', 'post-type-x' ); ?></td><td><input type="text" name="single_names[other_categories]" value="<?php echo esc_html( $single_names[ 'other_categories' ] ); ?>" /></td></tr>
							<tr><td><?php _e( 'Return to Products', 'post-type-x' ); ?></td><td><input type="text" name="single_names[return_to_archive]" value="<?php echo esc_html( $single_names[ 'return_to_archive' ] ); ?>" /></td></tr>
			...
			<div id="archive_names" class="setting-content submenu">
				...
				<form method="post" action="options.php"><?php
					...
					<table class="wp-list-table widefat product-settings-table" style="clear:right; text-align: left; width: 100%;">
						...
						<tbody>
							<?php
							implecode_settings_text( __( 'Main Listing Title', 'post-type-x' ), 'archive_names[all_products]', $archive_names[ 'all_products' ], null, 1, 'wide', null, $disabled );
							...
							implecode_settings_text( __( 'Category Products Header', 'post-type-x' ), 'archive_names[category_products]', $archive_names[ 'category_products' ], null, 1, 'wide', null, $disabled );
							implecode_settings_text( __( 'Next Page', 'post-type-x' ), 'archive_names[next_products]', $archive_names[ 'next_products' ], null, 1, 'wide', null, $disabled );
							implecode_settings_text( __( 'Previous Page', 'post-type-x' ), 'archive_names[previous_products]', $archive_names[ 'previous_products' ], null, 1, 'wide', null, $disabled );
