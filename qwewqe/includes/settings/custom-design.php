...
function ic_product_page_design_settings() {
	...
	implecode_upload_image( __( 'Default Image', 'post-type-x' ), 'default_product_thumbnail', get_default_product_image_src() )
	?>
	...
	<table>
		...
		implecode_settings_checkbox( __( 'Enable image magnifier', 'post-type-x' ), 'catalog_magnifier', $enable_catalog_magnifier, 1, __( 'The image on single page will be magnified when pointed with mouse cursor.', 'post-type-x' ) );
