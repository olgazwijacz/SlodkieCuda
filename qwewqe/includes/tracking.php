...
jQuery(this).parent("p").next("p").find("textarea").show();
	...
	function confirm_deactivation_box() {
		...
		$box .= '&nbsp;<a href="" class="deactivate button-secondary">' . __( 'Cancel', 'post-type-x' ) . '</a>';
		$box .= '</div>';
		$box .= '</div>';
		$box .= '</div>';
		return $box;
	...
	function confirm_deactivation_options() {
		$options = array(
			'dont-understand'		 => array( 'label' => __( "I couldn't understand how to make it work", 'post-type-x' ), 'placeholder' => __( "What we could do better?", 'post-type-x' ) ),
			'better-plugin'			 => array( 'label' => __( "I found a better plugin", 'post-type-x' ), 'placeholder' => __( "What's the plugin's name?", 'post-type-x' ) ),
			'missing-feature'		 => array( 'label' => __( "The plugin is great, but I need specific feature that you don't support", 'post-type-x' ), 'placeholder' => __( "What feature?", 'post-type-x' ) ),
			'not-working'			 => array( 'label' => __( "The plugin is not working", 'post-type-x' ), 'placeholder' => __( "Kindly share what didn't work so we can fix it for future users...", 'post-type-x' ) ),
			'looking-something-else' => array( 'label' => __( "It's not what I was looking for", 'post-type-x' ), 'placeholder' => __( "What you've been looking for?", 'post-type-x' ) ),
			'didnt-work'			 => array( 'label' => __( "The plugin didn't work as expected", 'post-type-x' ), 'placeholder' => __( "What did you expect?", 'post-type-x' ) ),
			'other'					 => array( 'label' => __( "Other", 'post-type-x' ), 'placeholder' => __( "What is the reason?", 'post-type-x' ) ),
		);
		return $options;
	}
